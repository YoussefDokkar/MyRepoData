...
HD_PWD='C:/Hardware_Project_2024/FinalProject_Hardware/FinalProject_Hardware.runs/Hardware_final_PmodACL_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hardware_final_PmodACL_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hardware_final_PmodACL_0_0.tcl
