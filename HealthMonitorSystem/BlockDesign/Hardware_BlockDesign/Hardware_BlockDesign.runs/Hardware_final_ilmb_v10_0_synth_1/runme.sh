...
HD_PWD='C:/HealthMonitorSystem/BlockDesign/Hardware_BlockDesign/Hardware_BlockDesign.runs/Hardware_final_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hardware_final_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hardware_final_ilmb_v10_0.tcl
