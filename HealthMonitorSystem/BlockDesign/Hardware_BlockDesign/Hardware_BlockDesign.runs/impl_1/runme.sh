...
HD_PWD='C:/HealthMonitorSystem/BlockDesign/Hardware_BlockDesign/Hardware_BlockDesign.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Hardware_final_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Hardware_final_wrapper.tcl -notrace
