...
HD_PWD='C:/HealthMonitorSystem/BlockDesign/Hardware_BlockDesign/Hardware_BlockDesign.runs/Hardware_final_ilmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hardware_final_ilmb_bram_if_cntlr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hardware_final_ilmb_bram_if_cntlr_1.tcl
